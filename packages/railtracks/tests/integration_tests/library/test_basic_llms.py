...
@pytest.mark.asyncio
async def test_ternial_llm_run_with_different_inputs(
    mock_llm, encoder_system_message, user_input_factory
):
...
@pytest.mark.asyncio
async def test_structured_llm_run_with_different_inputs(
    mock_llm, simple_output_model, user_input_factory
):
