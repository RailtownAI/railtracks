...
def test_apply_patches_jupyter_env(reset_patched_flag):
    ...
    with patch("railtracks.rt_mcp.jupyter_compat.is_jupyter", return_value=True):
        with patch("sys.platform", "win32"):
            ...
            original_create_windows_process = (
                mcp.os.win32.utilities.create_windows_process
            )
            original_create_windows_fallback_process = (
...
@pytest.mark.parametrize(
    "patch_function", ["create_windows_process", "_create_windows_fallback_process"]
)
