...
async def test_stream_publishes_streaming_message():
    with patch("railtracks.interaction.broadcast.get_publisher") as mock_get_publisher, \
         patch("railtracks.interaction.broadcast.get_parent_id") as mock_get_parent_id:
