...
def mock_dependencies(monkeypatch):
    ...
    monkeypatch.setattr(
        "railtracks._session.mark_session_logging_override",
        m_mark_session_logging_override,
    )
    monkeypatch.setattr(
        "railtracks._session.restore_module_logging", m_restore_module_logging
    )
...
def test_setup_subscriber_adds_subscriber_if_present():
    ...
    with patch(
        "railtracks._session.stream_subscriber", return_value="fake_stream_sub"
    ) as m_stream:
