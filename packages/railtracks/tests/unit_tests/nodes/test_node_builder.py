...
def test_tool_calling_llm_sets_tool_nodes_and_max(
    ...
    monkeypatch.setattr("railtracks.builtnodes._node_builder.isfunction", lambda obj: False)
...
def test_setup_function_node_sets_func_and_type_mapper(patch_function_node, dummy_tool, dummy_parameter, monkeypatch):
    monkeypatch.setattr("railtracks.builtnodes._node_builder.TypeMapper", lambda func: f"TM({func.__name__})")
    monkeypatch.setattr("railtracks.builtnodes._node_builder.Tool", dummy_tool)
...
def test_tool_callable_llm_sets_tool_info_and_prepare_tool(
    ...
    monkeypatch.setattr("railtracks.builtnodes._node_builder._check_tool_params_and_details", lambda p, d: None)
    monkeypatch.setattr("railtracks.builtnodes._node_builder._check_duplicate_param_names", lambda params: None)
