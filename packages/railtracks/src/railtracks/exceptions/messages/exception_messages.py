...
class ExceptionMessageKey(Enum):
    ...
    COMBINED_TOOLS_AND_SCHEMA_MSG = "COMBINED_TOOLS_AND_SCHEMA_MSG"
    COMBINED_TOOLS_AND_SCHEMA_NOTES = "COMBINED_TOOLS_AND_SCHEMA_NOTES"
    ...
    DUPLICATE_TOOL_NAMES_MSG = "DUPLICATE_TOOL_NAMES_MSG"
    DUPLICATE_TOOL_NAMES_NOTES = "DUPLICATE_TOOL_NAMES_NOTES"
    ...
    MID_CONVERSATION_SYSTEM_WARN = "MID_CONVERSATION_SYSTEM_WARN"
