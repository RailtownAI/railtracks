...
class PortKeyLLM(OpenAICompatibleProvider[_TStream]):
    ...
    def __init__(self, model_name: str, *, stream: _TStream = False, api_key: str | None = None):
        try:
            from portkey_ai import Portkey
        except ImportError:
            raise ImportError("Could not import portkey_ai package. Use railtracks[portkey]")
        ...
        super().__init__(model_name, stream=stream, api_base=portkey.base_url, api_key=portkey.api_key)
