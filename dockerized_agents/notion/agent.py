...
MCP_COMMAND = "npx"
MCP_ARGS = ["@notionhq/notion-mcp-server"]
...
user_prompt = """Create a new page in Notion called 'Jokes' under the parent page "Agent Root Demo" with a small joke at the top of the page."""
