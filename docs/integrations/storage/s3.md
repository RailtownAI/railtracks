...
```python
--8<-- "docs/scripts/integrations/storage_loaders.py:s3_prefix"
```

## Load specific keys

```python
--8<-- "docs/scripts/integrations/storage_loaders.py:s3_load_keys"
```

## Async usage

```python
--8<-- "docs/scripts/integrations/storage_loaders.py:s3_async"
```
...
```python
--8<-- "docs/scripts/integrations/storage_loaders.py:s3_explicit_creds"
```

## S3-compatible services (MinIO, LocalStack …)

```python
--8<-- "docs/scripts/integrations/storage_loaders.py:s3_minio"
```
