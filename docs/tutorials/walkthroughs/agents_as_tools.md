...
```python
--8<-- "docs/scripts/tutorials/agents_as_tools.py:calculation_agent"
```

??? info "Calculation Tools"
    Although these functions are simple, they demonstrate how to encapsulate functionality for an agent.
    ```python
    --8<-- "docs/scripts/tutorials/agents_as_tools.py:calculation_tools"
    ```
...
```python
--8<-- "docs/scripts/tutorials/agents_as_tools.py:call"
```
...
```python
--8<-- "docs/scripts/tutorials/agents_as_tools.py:shopping_agent"
```
??? info "Pricing Tool"
    ...
    ```python
    --8<-- "docs/scripts/tutorials/agents_as_tools.py:pricing_tool"
    ```
In this example: <br>
...
```python
--8<-- "docs/scripts/tutorials/agents_as_tools.py:shop_call"
```
