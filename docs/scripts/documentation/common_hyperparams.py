...
reasoning_llm = rt.llm.OpenAILLM("gpt-5-mini", reasoning_effort=rt.llm.ReasoningEffort.LOW)
# --8<-- [end: reasoning_effort]

# --8<-- [start: fail_fast]
import railtracks as rt
from railtracks.llm.models._model_exception_base import UnsupportedHyperparameterError
...
except UnsupportedHyperparameterError as e:
    print(e.reason)
