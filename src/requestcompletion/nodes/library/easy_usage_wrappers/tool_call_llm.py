...
from requestcompletion.nodes.library.tool_calling_llms._base import ToolCallLLMBase
...
) -> Type[ToolCallLLMBase[Union[MessageHistory, AssistantMessage, BaseModel]]]:
    if output_model:
