...
def structured_tool_call_llm(  # noqa: C901
    ...
    *,
    ...
    Args:
        ...
        output_type (Literal["MessageHistory", "LastMessage"], optional): The type of output this node will return. Defaults to "LastMessage".
        output_model (BaseModel): The Pydantic model that defines the structure of the output.
